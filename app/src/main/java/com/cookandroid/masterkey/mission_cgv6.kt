...
class mission_cgv6 : AppCompatActivity(), View.OnClickListener {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_main6_cgv)
        ...
        // 좌석 선택 버튼에 클릭 리스너 등록
        findViewById<View>(R.id.pay_6_cgv).setOnClickListener(this)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.pay_6_cgv -> {
                ...
                val intent = Intent(this, mission_cgv7::class.java)
                startActivity(intent)
            }
        }
    }
