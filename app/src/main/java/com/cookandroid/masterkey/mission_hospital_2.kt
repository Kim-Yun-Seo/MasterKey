...
class mission_hospital_2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mission_hospital2)
        ...
        btn_number.setOnClickListener{
            var dlg= AlertDialog.Builder(this@mission_hospital_2)
            dlg.setTitle("다시 선택해주세요!")
            dlg.setMessage("접수 버튼을 클릭해주세요.")
